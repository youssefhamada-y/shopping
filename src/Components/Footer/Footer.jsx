            ...
            <div className="-mx-4 flex flex-wrap justify-between">
              <div className="px-4 my-4 w-full xl:w-1/5">
                <a href="/" className="block w-56 mb-10">
                  <i className=" text-[32px]  text-green-700 fa-solid fa-cart-shopping"></i>
                  <span className="text-[28px] ms-1">YussCart</span>
                </a>
                <p className="text-justify leading-7 ">
                  If FreshCart is a clothing website, it might focus on offering
          ...
          <div className="container mx-auto px-4">
            <div className="-mx-4 flex flex-wrap justify-between">
              <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                Copyright © 2020 - 2022 YussCart. All Rights Reserved.
              </div>
              <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                Made with ❤️ by YussCart.
              </div>
            </div>
          </div>
        </div>
